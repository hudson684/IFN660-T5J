...
// GPPG version 1.5.2
// Machine:  VDI-VL17-001
// DateTime: 9/05/2017 8:41:33 PM
// UserName: n9648500
// Input file <parser.y - 9/05/2017 8:33:18 PM>
...
{
  // Verbatim content from parser.y - 9/05/2017 8:33:18 PM
#line 7 "parser.y"
public static Statement root;
#line default
  // End verbatim content from parser.y - 9/05/2017 8:33:18 PM

#pragma warning disable 649
  private static Dictionary<int, string> aliases;
#pragma warning restore 649
  private static Rule[] rules = new Rule[171];
  private static State[] states = new State[238];
  ...
  static Parser() {
    states[0] = new State(-5,new int[]{-87,1,-35,3,-49,4});
    states[1] = new State(new int[]{129,2});
    states[2] = new State(-1);
    states[3] = new State(-2);
    states[4] = new State(-6,new int[]{-65,5});
    states[5] = new State(-8,new int[]{-57,6});
    states[6] = new State(new int[]{129,-4,172,-13,155,-13,150,-13,145,-13,132,-13,170,-13,168,-13,175,-13},new int[]{-36,7,-37,8,-38,9,-79,10});
    states[7] = new State(-7);
    states[8] = new State(-9);
    states[9] = new State(-10);
    states[10] = new State(new int[]{172,11,155,231,150,232,145,233,132,234,170,235,168,236,175,237},new int[]{-76,230});
    ...
    states[15] = new State(new int[]{123,17},new int[]{-58,16});
    states[16] = new State(-11);
    states[17] = new State(-26,new int[]{-59,18});
    states[18] = new State(new int[]{125,19,171,-31,131,-31,152,-31,165,-31,164,-31,174,-31,167,-31,178,-31,148,-31,142,-31,155,-31,170,-31},new int[]{-39,20,-46,21,-47,22,-80,23});
    states[19] = new State(-24);
    states[20] = new State(-25);
    states[21] = new State(-27);
    states[22] = new State(-28);
    states[23] = new State(new int[]{171,226,131,223,152,54,165,55,164,56,174,57,167,58,178,60,148,61,142,62,155,228,170,229},new int[]{-84,24,-77,205,-66,206,-70,227,-72,46,-73,47,-74,48,-71,51,-69,52,-68,53,-67,59});
    states[24] = new State(new int[]{123,27,59,204},new int[]{-51,25,-50,26});
    states[25] = new State(-29);
    states[26] = new State(-71);
    states[27] = new State(new int[]{131,50,152,54,165,55,164,56,174,57,167,58,178,60,148,61,142,62,139,179,181,189,125,-75},new int[]{-61,28,-60,30,-44,203,-43,32,-42,33,-70,35,-72,46,-73,47,-74,48,-71,51,-69,52,-68,53,-67,59,-34,63,-41,64,-40,65,-2,66,-3,68,-4,69,-5,177,-54,178,-55,187,-53,188});
    states[28] = new State(new int[]{125,29});
    states[29] = new State(-73);
    states[30] = new State(new int[]{131,50,152,54,165,55,164,56,174,57,167,58,178,60,148,61,142,62,139,179,181,189,125,-74},new int[]{-44,31,-43,32,-42,33,-70,35,-72,46,-73,47,-74,48,-71,51,-69,52,-68,53,-67,59,-34,63,-41,64,-40,65,-2,66,-3,68,-4,69,-5,177,-54,178,-55,187,-53,188});
    states[31] = new State(-77);
    states[32] = new State(-78);
    states[33] = new State(new int[]{59,34});
    states[34] = new State(-80);
    states[35] = new State(new int[]{131,40},new int[]{-86,36,-83,45,-82,39});
    states[36] = new State(new int[]{44,37,59,-81});
    states[37] = new State(new int[]{131,40},new int[]{-83,38,-82,39});
    states[38] = new State(-83);
    states[39] = new State(-84);
    states[40] = new State(new int[]{91,43,44,-49,59,-49,41,-49},new int[]{-90,41,-91,42});
    ...
    states[48] = new State(new int[]{91,43},new int[]{-91,49});
    states[49] = new State(-69);
    states[50] = new State(new int[]{91,-70,61,-101});
    ...
    states[78] = new State(new int[]{61,-100,197,-159,198,-159,42,-159,47,-159,37,-159,43,-159,45,-159,199,-159,200,-159,201,-159,60,-159,62,-159,192,-159,191,-159,159,-159,190,-159,193,-159,38,-159,94,-159,124,-159,195,-159,196,-159,59,-159,41,-159});
    ...
    states[91] = new State(new int[]{190,92,193,168,38,-126,94,-126,124,-126,195,-126,196,-126,59,-126,41,-126});
    ...
    states[93] = new State(new int[]{60,94,62,159,192,161,191,163,159,165,190,-128,193,-128,38,-128,94,-128,124,-128,195,-128,196,-128,59,-128,41,-128});
    ...
    states[95] = new State(new int[]{199,96,200,154,201,156,60,-131,62,-131,192,-131,191,-131,159,-131,190,-131,193,-131,38,-131,94,-131,124,-131,195,-131,196,-131,59,-131,41,-131});
    ...
    states[97] = new State(new int[]{43,98,45,151,199,-137,200,-137,201,-137,60,-137,62,-137,192,-137,191,-137,159,-137,190,-137,193,-137,38,-137,94,-137,124,-137,195,-137,196,-137,59,-137,41,-137});
    ...
    states[99] = new State(new int[]{42,100,47,146,37,148,43,-141,45,-141,199,-141,200,-141,201,-141,60,-141,62,-141,192,-141,191,-141,159,-141,190,-141,193,-141,38,-141,94,-141,124,-141,195,-141,196,-141,59,-141,41,-141});
    ...
    states[113] = new State(new int[]{197,114,198,115,42,-154,47,-154,37,-154,43,-154,45,-154,199,-154,200,-154,201,-154,60,-154,62,-154,192,-154,191,-154,159,-154,190,-154,193,-154,38,-154,94,-154,124,-154,195,-154,196,-154,59,-154,41,-154});
    states[114] = new State(-162);
    states[115] = new State(-163);
    states[116] = new State(-158);
    states[117] = new State(-105);
    states[118] = new State(-106);
    states[119] = new State(-107);
    states[120] = new State(-108);
    states[121] = new State(-109);
    states[122] = new State(-110);
    states[123] = new State(-159);
    states[124] = new State(-160);
    states[125] = new State(-161);
    ...
    states[129] = new State(-156);
    states[130] = new State(-157);
    states[131] = new State(new int[]{152,54,165,55,164,56,174,57,167,58,178,60,148,61,142,143,131,145},new int[]{-92,132,-75,135,-69,142,-68,53,-67,59,-93,144});
    ...
    states[134] = new State(-164);
    states[135] = new State(-168,new int[]{-96,136});
    states[136] = new State(new int[]{41,137,38,141},new int[]{-97,140});
    states[137] = new State(new int[]{182,119,183,120,184,121,185,122,131,79,126,126,33,128,40,131,194,-114},new int[]{-30,138,-12,139,-26,113,-27,116,-10,117,-1,118,-5,123,-32,124,-33,125,-31,130,-95,73});
    states[138] = new State(-165);
    states[139] = new State(-166);
    states[140] = new State(-167);
    states[141] = new State(-169);
    ...
    states[149] = new State(-146);
    states[150] = new State(-143);
    ...
    states[152] = new State(new int[]{42,100,47,146,37,148,43,-142,45,-142,199,-142,200,-142,201,-142,60,-142,62,-142,192,-142,191,-142,159,-142,190,-142,193,-142,38,-142,94,-142,124,-142,195,-142,196,-142,59,-142,41,-142});
    states[153] = new State(new int[]{42,100,47,146,37,148,43,-140,45,-140,199,-140,200,-140,201,-140,60,-140,62,-140,192,-140,191,-140,159,-140,190,-140,193,-140,38,-140,94,-140,124,-140,195,-140,196,-140,59,-140,41,-140});
    ...
    states[155] = new State(new int[]{43,98,45,151,199,-138,200,-138,201,-138,60,-138,62,-138,192,-138,191,-138,159,-138,190,-138,193,-138,38,-138,94,-138,124,-138,195,-138,196,-138,59,-138,41,-138});
    ...
    states[157] = new State(new int[]{43,98,45,151,199,-139,200,-139,201,-139,60,-139,62,-139,192,-139,191,-139,159,-139,190,-139,193,-139,38,-139,94,-139,124,-139,195,-139,196,-139,59,-139,41,-139});
    states[158] = new State(new int[]{43,98,45,151,199,-136,200,-136,201,-136,60,-136,62,-136,192,-136,191,-136,159,-136,190,-136,193,-136,38,-136,94,-136,124,-136,195,-136,196,-136,59,-136,41,-136});
    ...
    states[160] = new State(new int[]{199,96,200,154,201,156,60,-132,62,-132,192,-132,191,-132,159,-132,190,-132,193,-132,38,-132,94,-132,124,-132,195,-132,196,-132,59,-132,41,-132});
    ...
    states[162] = new State(new int[]{199,96,200,154,201,156,60,-133,62,-133,192,-133,191,-133,159,-133,190,-133,193,-133,38,-133,94,-133,124,-133,195,-133,196,-133,59,-133,41,-133});
    ...
    states[164] = new State(new int[]{199,96,200,154,201,156,60,-134,62,-134,192,-134,191,-134,159,-134,190,-134,193,-134,38,-134,94,-134,124,-134,195,-134,196,-134,59,-134,41,-134});
    states[165] = new State(new int[]{131,145},new int[]{-75,166,-93,144});
    states[166] = new State(-135);
    states[167] = new State(new int[]{199,96,200,154,201,156,60,-130,62,-130,192,-130,191,-130,159,-130,190,-130,193,-130,38,-130,94,-130,124,-130,195,-130,196,-130,59,-130,41,-130});
    ...
    states[169] = new State(new int[]{60,94,62,159,192,161,191,163,159,165,190,-129,193,-129,38,-129,94,-129,124,-129,195,-129,196,-129,59,-129,41,-129});
    states[170] = new State(new int[]{60,94,62,159,192,161,191,163,159,165,190,-127,193,-127,38,-127,94,-127,124,-127,195,-127,196,-127,59,-127,41,-127});
    states[171] = new State(new int[]{190,92,193,168,38,-125,94,-125,124,-125,195,-125,196,-125,59,-125,41,-125});
    states[172] = new State(new int[]{38,90,94,-123,124,-123,195,-123,196,-123,59,-123,41,-123});
    states[173] = new State(new int[]{94,88,124,-121,195,-121,196,-121,59,-121,41,-121});
    states[174] = new State(new int[]{124,86,195,-119,196,-119,59,-119,41,-119});
    states[175] = new State(new int[]{195,84,196,-117,59,-117,41,-117});
    states[176] = new State(-102);
    states[177] = new State(-100);
    states[178] = new State(-87);
    states[179] = new State(new int[]{40,180});
    states[180] = new State(new int[]{131,79,197,103,198,106,43,108,45,110,182,119,183,120,184,121,185,122,126,126,33,128,40,131,194,-114},new int[]{-11,181,-12,72,-95,73,-9,76,-3,77,-4,69,-5,78,-14,80,-15,81,-16,175,-17,174,-18,173,-19,172,-20,171,-21,170,-22,167,-23,158,-24,153,-25,150,-28,102,-29,105,-30,112,-26,113,-27,116,-10,117,-1,118,-32,124,-33,125,-31,130});
    states[181] = new State(new int[]{41,182});
    states[182] = new State(new int[]{131,79,139,195,181,189},new int[]{-34,183,-52,184,-41,194,-40,65,-2,66,-3,68,-4,69,-5,177,-54,178,-55,187,-53,188,-56,202});
    states[183] = new State(-95);
    states[184] = new State(new int[]{153,185});
    states[185] = new State(new int[]{131,79,139,179,181,189},new int[]{-34,186,-41,64,-40,65,-2,66,-3,68,-4,69,-5,177,-54,178,-55,187,-53,188});
    states[186] = new State(-96);
    states[187] = new State(-88);
    states[188] = new State(-89);
    states[189] = new State(new int[]{40,190});
    states[190] = new State(new int[]{131,79,197,103,198,106,43,108,45,110,182,119,183,120,184,121,185,122,126,126,33,128,40,131,194,-114},new int[]{-11,191,-12,72,-95,73,-9,76,-3,77,-4,69,-5,78,-14,80,-15,81,-16,175,-17,174,-18,173,-19,172,-20,171,-21,170,-22,167,-23,158,-24,153,-25,150,-28,102,-29,105,-30,112,-26,113,-27,116,-10,117,-1,118,-32,124,-33,125,-31,130});
    states[191] = new State(new int[]{41,192});
    states[192] = new State(new int[]{131,79,139,179,181,189},new int[]{-34,193,-41,64,-40,65,-2,66,-3,68,-4,69,-5,177,-54,178,-55,187,-53,188});
    states[193] = new State(-98);
    states[194] = new State(new int[]{131,-86,152,-86,165,-86,164,-86,174,-86,167,-86,178,-86,148,-86,142,-86,139,-86,181,-86,125,-86,153,-90});
    states[195] = new State(new int[]{40,196});
    states[196] = new State(new int[]{131,79,197,103,198,106,43,108,45,110,182,119,183,120,184,121,185,122,126,126,33,128,40,131,194,-114},new int[]{-11,197,-12,72,-95,73,-9,76,-3,77,-4,69,-5,78,-14,80,-15,81,-16,175,-17,174,-18,173,-19,172,-20,171,-21,170,-22,167,-23,158,-24,153,-25,150,-28,102,-29,105,-30,112,-26,113,-27,116,-10,117,-1,118,-32,124,-33,125,-31,130});
    states[197] = new State(new int[]{41,198});
    states[198] = new State(new int[]{131,79,139,195,181,189},new int[]{-34,183,-52,199,-41,194,-40,65,-2,66,-3,68,-4,69,-5,177,-54,178,-55,187,-53,188,-56,202});
    states[199] = new State(new int[]{153,200});
    states[200] = new State(new int[]{131,79,139,195,181,189},new int[]{-34,186,-52,201,-41,194,-40,65,-2,66,-3,68,-4,69,-5,177,-54,178,-55,187,-53,188,-56,202});
    states[201] = new State(-97);
    states[202] = new State(-91);
    states[203] = new State(-76);
    states[204] = new State(-72);
    states[205] = new State(-30);
    states[206] = new State(new int[]{131,210},new int[]{-85,207});
    states[207] = new State(-3,new int[]{-45,208,-89,209});
    states[208] = new State(-34);
    states[209] = new State(-37);
    states[210] = new State(new int[]{40,211});
    states[211] = new State(new int[]{131,-46,152,-46,165,-46,164,-46,174,-46,167,-46,178,-46,148,-46,142,-46,168,-46,41,-40},new int[]{-64,212,-63,215,-62,216,-48,225,-81,219});
    states[212] = new State(new int[]{41,213});
    states[213] = new State(new int[]{91,43,123,-49,59,-49},new int[]{-90,214,-91,42});
    states[214] = new State(-38);
    states[215] = new State(-39);
    states[216] = new State(new int[]{44,217,41,-41});
    states[217] = new State(-46,new int[]{-48,218,-81,219});
    states[218] = new State(-43);
    states[219] = new State(new int[]{131,223,152,54,165,55,164,56,174,57,167,58,178,60,148,61,142,62,168,224},new int[]{-70,220,-78,222,-72,46,-73,47,-74,48,-71,51,-69,52,-68,53,-67,59});
    states[220] = new State(new int[]{131,40},new int[]{-82,221});
    states[221] = new State(-44);
    states[222] = new State(-45);
    states[223] = new State(-70);
    states[224] = new State(-47);
    states[225] = new State(-42);
    ...
    rules[1] = new Rule(-88, new int[]{-87,129});
    rules[2] = new Rule(-87, new int[]{-35});
    rules[3] = new Rule(-89, new int[]{});
    rules[4] = new Rule(-35, new int[]{-49,-65,-57});
    rules[5] = new Rule(-49, new int[]{});
    rules[6] = new Rule(-65, new int[]{});
    rules[7] = new Rule(-57, new int[]{-57,-36});
    rules[8] = new Rule(-57, new int[]{});
    rules[9] = new Rule(-36, new int[]{-37});
    rules[10] = new Rule(-37, new int[]{-38});
    rules[11] = new Rule(-38, new int[]{-79,172,131,-6,-7,-8,-58});
    rules[12] = new Rule(-79, new int[]{-79,-76});
    rules[13] = new Rule(-79, new int[]{});
    rules[14] = new Rule(-76, new int[]{155});
    rules[15] = new Rule(-76, new int[]{150});
    rules[16] = new Rule(-76, new int[]{145});
    rules[17] = new Rule(-76, new int[]{132});
    rules[18] = new Rule(-76, new int[]{170});
    rules[19] = new Rule(-76, new int[]{168});
    rules[20] = new Rule(-76, new int[]{175});
    rules[21] = new Rule(-6, new int[]{});
    rules[22] = new Rule(-7, new int[]{});
    rules[23] = new Rule(-8, new int[]{});
    rules[24] = new Rule(-58, new int[]{123,-59,125});
    rules[25] = new Rule(-59, new int[]{-59,-39});
    rules[26] = new Rule(-59, new int[]{});
    rules[27] = new Rule(-39, new int[]{-46});
    rules[28] = new Rule(-46, new int[]{-47});
    rules[29] = new Rule(-47, new int[]{-80,-84,-51});
    rules[30] = new Rule(-80, new int[]{-80,-77});
    rules[31] = new Rule(-80, new int[]{});
    rules[32] = new Rule(-77, new int[]{155});
    rules[33] = new Rule(-77, new int[]{170});
    rules[34] = new Rule(-84, new int[]{-66,-85,-45});
    rules[35] = new Rule(-66, new int[]{171});
    rules[36] = new Rule(-66, new int[]{-70});
    rules[37] = new Rule(-45, new int[]{-89});
    rules[38] = new Rule(-85, new int[]{131,40,-64,41,-90});
    rules[39] = new Rule(-64, new int[]{-63});
    rules[40] = new Rule(-64, new int[]{});
    rules[41] = new Rule(-63, new int[]{-62});
    rules[42] = new Rule(-62, new int[]{-48});
    rules[43] = new Rule(-62, new int[]{-62,44,-48});
    rules[44] = new Rule(-48, new int[]{-81,-70,-82});
    rules[45] = new Rule(-81, new int[]{-81,-78});
    rules[46] = new Rule(-81, new int[]{});
    rules[47] = new Rule(-78, new int[]{168});
    rules[48] = new Rule(-90, new int[]{-91});
    rules[49] = new Rule(-90, new int[]{});
    rules[50] = new Rule(-91, new int[]{91,93});
    rules[51] = new Rule(-70, new int[]{-72});
    rules[52] = new Rule(-70, new int[]{-71});
    rules[53] = new Rule(-71, new int[]{-69});
    rules[54] = new Rule(-71, new int[]{142});
    rules[55] = new Rule(-92, new int[]{-69});
    rules[56] = new Rule(-92, new int[]{142});
    rules[57] = new Rule(-75, new int[]{-93});
    rules[58] = new Rule(-93, new int[]{131});
    rules[59] = new Rule(-69, new int[]{-68});
    rules[60] = new Rule(-69, new int[]{-67});
    rules[61] = new Rule(-68, new int[]{152});
    rules[62] = new Rule(-68, new int[]{165});
    rules[63] = new Rule(-68, new int[]{164});
    rules[64] = new Rule(-68, new int[]{174});
    rules[65] = new Rule(-68, new int[]{167});
    rules[66] = new Rule(-67, new int[]{178});
    rules[67] = new Rule(-67, new int[]{148});
    rules[68] = new Rule(-72, new int[]{-73});
    rules[69] = new Rule(-73, new int[]{-74,-91});
    rules[70] = new Rule(-74, new int[]{131});
    rules[71] = new Rule(-51, new int[]{-50});
    rules[72] = new Rule(-51, new int[]{59});
    rules[73] = new Rule(-50, new int[]{123,-61,125});
    rules[74] = new Rule(-61, new int[]{-60});
    rules[75] = new Rule(-61, new int[]{});
    rules[76] = new Rule(-60, new int[]{-44});
    rules[77] = new Rule(-60, new int[]{-60,-44});
    rules[78] = new Rule(-44, new int[]{-43});
    rules[79] = new Rule(-44, new int[]{-34});
    rules[80] = new Rule(-43, new int[]{-42,59});
    rules[81] = new Rule(-42, new int[]{-70,-86});
    rules[82] = new Rule(-86, new int[]{-83});
    rules[83] = new Rule(-86, new int[]{-86,44,-83});
    rules[84] = new Rule(-83, new int[]{-82});
    rules[85] = new Rule(-82, new int[]{131,-90});
    ...
    rules[90] = new Rule(-52, new int[]{-41});
    rules[91] = new Rule(-52, new int[]{-56});
    rules[92] = new Rule(-41, new int[]{-40});
    rules[93] = new Rule(-40, new int[]{-2,59});
    rules[94] = new Rule(-2, new int[]{-3});
    rules[95] = new Rule(-54, new int[]{139,40,-11,41,-34});
    rules[96] = new Rule(-55, new int[]{139,40,-11,41,-52,153,-34});
    rules[97] = new Rule(-56, new int[]{139,40,-11,41,-52,153,-52});
    rules[98] = new Rule(-53, new int[]{181,40,-11,41,-34});
    rules[99] = new Rule(-3, new int[]{-4,-94,-11});
    rules[100] = new Rule(-4, new int[]{-5});
    rules[101] = new Rule(-5, new int[]{131});
    rules[102] = new Rule(-94, new int[]{61});
    ...
    rules[113] = new Rule(-12, new int[]{-95,194,-13});
    rules[114] = new Rule(-95, new int[]{});
    ...
    rules[135] = new Rule(-21, new int[]{-21,159,-75});
    ...
    rules[147] = new Rule(-25, new int[]{-28});
    rules[148] = new Rule(-25, new int[]{-29});
    rules[149] = new Rule(-25, new int[]{43,-25});
    rules[150] = new Rule(-25, new int[]{45,-25});
    rules[151] = new Rule(-25, new int[]{-30});
    rules[152] = new Rule(-28, new int[]{197,-25});
    rules[153] = new Rule(-29, new int[]{198,-25});
    rules[154] = new Rule(-30, new int[]{-26});
    rules[155] = new Rule(-30, new int[]{126,-25});
    rules[156] = new Rule(-30, new int[]{33,-25});
    rules[157] = new Rule(-30, new int[]{-31});
    rules[158] = new Rule(-26, new int[]{-27});
    rules[159] = new Rule(-26, new int[]{-5});
    rules[160] = new Rule(-26, new int[]{-32});
    rules[161] = new Rule(-26, new int[]{-33});
    rules[162] = new Rule(-32, new int[]{-26,197});
    rules[163] = new Rule(-33, new int[]{-26,198});
    rules[164] = new Rule(-31, new int[]{40,-92,41,-25});
    rules[165] = new Rule(-31, new int[]{40,-75,-96,41,-30});
    rules[166] = new Rule(-31, new int[]{40,-75,-96,41,-12});
    rules[167] = new Rule(-96, new int[]{-96,-97});
    rules[168] = new Rule(-96, new int[]{});
    rules[169] = new Rule(-97, new int[]{38});
    rules[170] = new Rule(-98, new int[]{-11});
  }
...
#line default
        break;
      case 97: // IfThenElseStatementNoShortIf -> IF, '(', Expression, ')', StatementNoShortIf, 
               //                                 ELSE, StatementNoShortIf
#line 418 "parser.y"
                                                                      { CurrentSemanticValue.stmt = new IfStatement(ValueStack[ValueStack.Depth-5].expr, ValueStack[ValueStack.Depth-3].stmt, ValueStack[ValueStack.Depth-1].stmt); }
#line default
        break;
      case 98: // WhileStatement -> WHILE, '(', Expression, ')', Statement
#line 422 "parser.y"
...
#line default
        break;
      case 147: // UnaryExpression -> PreIncrementExpression
#line 550 "parser.y"
                                    { CurrentSemanticValue.expr = ValueStack[ValueStack.Depth-1].expr; }
#line default
        break;
      case 148: // UnaryExpression -> PreDecrementExpression
#line 551 "parser.y"
                                   { CurrentSemanticValue.expr = ValueStack[ValueStack.Depth-1].expr; }
#line default
        break;
      case 149: // UnaryExpression -> '+', UnaryExpression
#line 552 "parser.y"
...
#line default
        break;
      case 151: // UnaryExpression -> UnaryExpressionNotPlusMinus
#line 554 "parser.y"
                                       { CurrentSemanticValue.expr = ValueStack[ValueStack.Depth-1].expr; }
#line default
        break;
      case 152: // PreIncrementExpression -> INCREMENT, UnaryExpression
#line 562 "parser.y"
                                      { CurrentSemanticValue.expr = new PreUnaryExpression("++", ValueStack[ValueStack.Depth-1].expr); }
#line default
        break;
      case 153: // PreDecrementExpression -> DECREMENT, UnaryExpression
#line 566 "parser.y"
                                      { CurrentSemanticValue.expr = new PreUnaryExpression("--", ValueStack[ValueStack.Depth-1].expr); }
#line default
        break;
      case 154: // UnaryExpressionNotPlusMinus -> PostfixExpression
#line 570 "parser.y"
                                { CurrentSemanticValue.expr = ValueStack[ValueStack.Depth-1].expr;}
#line default
        break;
      case 155: // UnaryExpressionNotPlusMinus -> '~', UnaryExpression
#line 571 "parser.y"
                                 { CurrentSemanticValue.expr = new PreUnaryExpression("~", ValueStack[ValueStack.Depth-1].expr); }
#line default
        break;
...
#line default
        break;
      case 157: // UnaryExpressionNotPlusMinus -> CastExpression
#line 573 "parser.y"
                             { CurrentSemanticValue.expr = ValueStack[ValueStack.Depth-1].expr;}
#line default
        break;
...
#line default
        break;
      case 159: // PostfixExpression -> ExpressionName
#line 578 "parser.y"
                             { CurrentSemanticValue.expr = ValueStack[ValueStack.Depth-1].expr; }
#line default
        break;
...
#line default
        break;
      case 162: // PostIncrementExpression -> PostfixExpression, INCREMENT
#line 584 "parser.y"
                                        { CurrentSemanticValue.expr = new PostUnaryExpression(ValueStack[ValueStack.Depth-2].expr, "++"); }
#line default
        break;
      case 163: // PostDecrementExpression -> PostfixExpression, DECREMENT
#line 588 "parser.y"
                                        { CurrentSemanticValue.expr = new PostUnaryExpression(ValueStack[ValueStack.Depth-2].expr, "--"); }
#line default
        break;
