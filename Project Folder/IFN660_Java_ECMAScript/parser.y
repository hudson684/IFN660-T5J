...
%type <expr> Expression_opt, ForUpdate_opt, ForUpdate, ForInit, ForInit_opt

%type <exprs> StatementExpressionList
...
%type <stmt> PackageDeclaration_opt, ForStatement, BasicForStatement
...
ForInit_opt
		...
		;
ForInit
		: StatementExpressionList								{ $$ = new StatementExpressionList($1); } // Tristan
		| LocalVariableDeclaration								{ $$ = new LocalVariableDeclaration($1); } // Tristan
		;
...
StatementExpressionList
		: StatementExpression									{ $$ = new List<Expression> { $1 }; }
