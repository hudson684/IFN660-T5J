...
<<<<<<< HEAD
    ...
    public class ForStatement : Statement
    {
        ...
        public ForStatement(Expression ForInit, Expression TestExpr, Expression ForUpdate, Statement Statements)
        {
...
>>>>>>> master
        ...
        {
<<<<<<< HEAD
            var newScope = getNewScope(scope, new List<Statement> { Statements }, null);
            //bool loopResolve = true;
            ...
            **/
            return ForInit.ResolveNames(newScope) & TestExpr.ResolveNames(newScope) & ForUpdate.ResolveNames(newScope);
...
<<<<<<< HEAD
    ...
    public class StatementExpressionList : Expression
    {
        private List<Expression> stmntExpr;

        public StatementExpressionList( List<Expression> stmntExpr)
        {
            this.stmntExpr = stmntExpr;
=======
...
<<<<<<< HEAD
            foreach (Expression each in stmntExpr)
            {
                loopResolve = loopResolve & each.ResolveNames(scope);
            }
    ...
    public class LocalVariableDeclaration : Expression
    {
        private Statement Statements;
        public LocalVariableDeclaration(Statement Statements)
        {
            this.Statements = Statements;
        }
